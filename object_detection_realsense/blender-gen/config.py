...
class cfg:
  def __init__(self):
    ...
    self.model_path = "/home/daerion/Programs/verteilte_industrielle_steuerungssysteme/3d_models/pepper/pepper/pepper.obj"#"/home/daerion/Programs/vis/3d_models/pepper-cropped/pepper-cropped.obj"  # filepath to object
    ...
    #  CAMERA
    self.clip_end = 80 # 50
    self.clip_start = 5 # 0.01
    # camera sphere coordinates
    self.cam_rmin = 20  # minimum camera distance
    self.cam_rmax = 50#300 #100 |1.3  # maximum camera distance
    self.cam_incmin = 0.1 * pi
    self.cam_incmax = 0.6 * pi
    self.cam_azimin = 0
    ...
    self.obj_location_zmin =  -5
    self.obj_location_zmax =  -15
