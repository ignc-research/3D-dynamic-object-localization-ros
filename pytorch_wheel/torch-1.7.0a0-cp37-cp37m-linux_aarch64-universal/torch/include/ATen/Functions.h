...
CAFFE2_API std::vector<Tensor> _foreach_add_scalar_list(TensorList tensors, ArrayRef<double> scalars);

CAFFE2_API void _foreach_add_scalar_list_(TensorList self, ArrayRef<double> scalars);

CAFFE2_API std::vector<Tensor> _foreach_sub_scalar_list(TensorList tensors, ArrayRef<double> scalars);

CAFFE2_API void _foreach_sub_scalar_list_(TensorList self, ArrayRef<double> scalars);

CAFFE2_API std::vector<Tensor> _foreach_div_scalar_list(TensorList tensors, ArrayRef<double> scalars);

CAFFE2_API void _foreach_div_scalar_list_(TensorList self, ArrayRef<double> scalars);

CAFFE2_API std::vector<Tensor> _foreach_mul_scalar_list(TensorList tensors, ArrayRef<double> scalars);

CAFFE2_API void _foreach_mul_scalar_list_(TensorList self, ArrayRef<double> scalars);
